...
| Last APK on disk | **v.126** — do not label it v.148 |
...
- Confirmed: `public/game/clock/1.mp4` through `7.mp4`. `HOUR_INTRO_READY` is 1–7.
- Waiting: `clock-splices/8-oclock.mp4` (2.45s–4.25s of clock-7-12, "It's eight o'clock" only).
