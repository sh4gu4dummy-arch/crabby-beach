...
| Last APK on disk | **v.126** — do not label it v.147 |
...
- Confirmed: `public/game/clock/1.mp4` through `6.mp4`. `HOUR_INTRO_READY` is 1–6.
- Waiting: `clock-splices/7-oclock.mp4` (0.00s–2.20s of clock-7-12, "It's seven o'clock" only).
