...
```md
# export-naming.md — v.020

Current product version: **v.019** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.020**.
...
export const APP_VERSION = "v.019";
