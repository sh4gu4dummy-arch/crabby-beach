...
```md
# export-naming.md — v.032

Current product version: **v.031** (Crabby Beach)
...
| --- | --- | --- |
| Code only | `crabby-beach-v.031-code.md` | One Markdown document: table of contents + essential source in fenced code blocks. For read / search / share / archive. **Not runnable.** No voice, no art assets. |
| Code + assets (full) | `crabby-beach-v.031-codebase.zip` | Complete project tree, including data, generated assets, and config, for offline rebuild. |
| Portable app | `crabby-beach-v.031-portable.zip` | Playable, offline-ready. Unzip and open. |
| Android project | `crabby-beach-v.031-android.zip` | Android project + build readme. |
| Android APK | `crabby-beach-v.031.apk` | Installable APK for this version. |
...
- This naming document started at `v.001` and is now **v.032**.
