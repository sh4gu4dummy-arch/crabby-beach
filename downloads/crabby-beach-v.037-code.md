...
```md
# export-naming.md — v.038

Current product version: **v.037** (Crabby Beach)
...
| --- | --- | --- |
| Code only | `crabby-beach-v.037-code.md` | One Markdown document: table of contents + essential source in fenced code blocks. For read / search / share / archive. **Not runnable.** No voice, no art assets. |
| Code + assets (full) | `crabby-beach-v.037-codebase.zip` | Complete project tree, including data, generated assets, and config, for offline rebuild. |
| Portable app | `crabby-beach-v.037-portable.zip` | Playable, offline-ready. Unzip and open. |
| Android project | `crabby-beach-v.037-android.zip` | Android project + build readme. |
| Android APK | `crabby-beach-v.037.apk` | Installable APK for this version. |
...
- This naming document started at `v.001` and is now **v.038**.
...
export const APP_VERSION = "v.037";
...
function IntroOverlay({
  ...
  function captionAt(t: number) {
    if (t < 1.8) return "Hi! I'm Crabby.";
    if (t < 3.6) return "Tap a white shell.";
    if (t < 5.4) return "I will walk over.";
    if (t < 7.6) return "Then paint it with your finger.";
    return "Let's play!";
  }
  ...
  return (
    <div className="absolute inset-0 z-50 bg-ink">
      <video
        ref={ref}
        src={assetUrl("game/intro.mp4?v=037")}
        playsInline
