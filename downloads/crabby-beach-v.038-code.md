...
```md
# export-naming.md — v.039

Current product version: **v.038** (Crabby Beach)
...
| --- | --- | --- |
| Code only | `crabby-beach-v.038-code.md` | One Markdown document: table of contents + essential source in fenced code blocks. For read / search / share / archive. **Not runnable.** No voice, no art assets. |
| Code + assets (full) | `crabby-beach-v.038-codebase.zip` | Complete project tree, including data, generated assets, and config, for offline rebuild. |
| Portable app | `crabby-beach-v.038-portable.zip` | Playable, offline-ready. Unzip and open. |
| Android project | `crabby-beach-v.038-android.zip` | Android project + build readme. |
| Android APK | `crabby-beach-v.038.apk` | Installable APK for this version. |
...
- This naming document started at `v.001` and is now **v.039**.
...
export const APP_VERSION = "v.038";
...
function IntroOverlay({
  ...
  function captionAt(t: number) {
    ...
    if (t < 3.0) return "Tap a white shell!";
    if (t < 4.5) return "I will walk over!";
    if (t < 6.5) return "Then paint it with your finger!";
    return "Let's play!";
  }
  ...
  return (
    <div className="absolute inset-0 z-50 bg-ink">
      <video
        ref={ref}
        src={assetUrl("game/intro.mp4?v=038")}
        playsInline
