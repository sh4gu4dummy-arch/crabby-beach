...
```md
# export-naming.md — v.077

Current product version: **v.076** (Crabby Beach)
...
| --- | --- | --- |
| Code only | `crabby-beach-v.076-code.md` | One Markdown document: table of contents + essential source in fenced code blocks. For read / search / share / archive. **Not runnable.** No voice, no art assets. |
| Code + assets (full) | `crabby-beach-v.076-codebase.zip` | Complete project tree, including data, generated assets, and config, for offline rebuild. |
| Portable app | `crabby-beach-v.076-portable.zip` | Playable, offline-ready. Unzip and open. |
| Android project | `crabby-beach-v.076-android.zip` | Android project + build readme. |
| Android APK | `crabby-beach-v.076.apk` | Installable APK for this version. |
...
- This naming document started at `v.001` and is now **v.077**.
...
export const APP_VERSION = "v.076";
