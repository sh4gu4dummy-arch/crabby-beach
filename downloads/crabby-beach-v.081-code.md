...
```md
# export-naming.md — v.082

Current product version: **v.081** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.082**.
...
export const APP_VERSION = "v.081";
