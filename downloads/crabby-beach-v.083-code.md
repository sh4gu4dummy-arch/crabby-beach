...
```md
# export-naming.md — v.084

Current product version: **v.083** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.084**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.082",
    "file": "crabby-beach-v.082-code.md",
    "bytes": 173304,
    "mtime": "2026-09-09T16:25:25.942Z"
  },
  "codebase": {
    "version": "v.080",
...
export const APP_VERSION = "v.083";
