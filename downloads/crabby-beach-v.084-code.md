...
```md
# export-naming.md — v.085

Current product version: **v.084** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.085**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.083",
    "file": "crabby-beach-v.083-code.md",
    "bytes": 176623,
    "mtime": "2026-09-09T16:29:37.478Z"
  },
  "codebase": {
    "version": "v.080",
...
export const APP_VERSION = "v.084";
