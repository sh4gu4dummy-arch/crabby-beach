...
GitHub: v.090 next. Publish: user clicks it.
```

## export-naming.md

```md
# export-naming.md — v.086

Current product version: **v.085** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.086**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.084",
    "file": "crabby-beach-v.084-code.md",
    "bytes": 176434,
    "mtime": "2026-09-09T16:38:46.414Z"
  },
  "codebase": {
    "version": "v.080",
...
export const APP_VERSION = "v.085";
