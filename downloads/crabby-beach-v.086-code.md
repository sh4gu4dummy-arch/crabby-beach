...
Publish: user clicks it. Do not claim it unless they give a URL.
```

## export-naming.md

```md
# export-naming.md — v.087

Current product version: **v.086** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.087**.
...
export const APP_VERSION = "v.086";
