...
Dev mode defaults on. Intro autoplays once, and only when dev is off.
```

## export-naming.md

```md
# export-naming.md — v.088

Current product version: **v.087** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.088**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.086",
    "file": "crabby-beach-v.086-code.md",
    "bytes": 176599,
    "mtime": "2026-09-09T17:18:57.964Z"
  },
  "codebase": {
    "version": "v.080",
...
export const APP_VERSION = "v.087";
