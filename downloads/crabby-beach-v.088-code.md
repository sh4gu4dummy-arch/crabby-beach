...
```md
# export-naming.md — v.089

Current product version: **v.088** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.089**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.087",
    "file": "crabby-beach-v.087-code.md",
    "bytes": 177095,
    "mtime": "2026-09-09T17:29:43.272Z"
  },
  "codebase": {
    "version": "v.080",
...
export const APP_VERSION = "v.088";
