...
```md
# export-naming.md — v.092

Current product version: **v.091** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.092**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.090",
    "file": "crabby-beach-v.090-code.md",
    "bytes": 180073,
    "mtime": "2026-09-10T14:04:44.704Z"
  },
  "codebase": {
    "version": "v.090",
...
export const APP_VERSION = "v.091";
