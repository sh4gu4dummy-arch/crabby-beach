...
```md
# export-naming.md — v.094

Current product version: **v.093** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.094**.
...
export const APP_VERSION = "v.093";
