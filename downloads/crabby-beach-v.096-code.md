...
Real blue/yellow crab sprites and hat pictures in Loadout.
```

## export-naming.md

```md
# export-naming.md — v.097

Current product version: **v.096** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.097**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.095",
    "file": "crabby-beach-v.095-code.md",
    "bytes": 180420,
    "mtime": "2026-09-10T14:17:44.404Z"
  },
  "codebase": {
    "version": "v.090",
...
export const APP_VERSION = "v.096";
