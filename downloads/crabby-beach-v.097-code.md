...
Hats sit on the shell. Menu shows the chosen loadout.
```

## export-naming.md

```md
# export-naming.md — v.098

Current product version: **v.097** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.098**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.096",
    "file": "crabby-beach-v.096-code.md",
    "bytes": 181390,
    "mtime": "2026-09-10T14:24:49.412Z"
  },
  "codebase": {
    "version": "v.090",
