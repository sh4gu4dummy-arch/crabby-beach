...
Checkerboard boxed around blue/yellow crab is gone.
```

## export-naming.md

```md
# export-naming.md — v.099

Current product version: **v.098** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.099**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.097",
    "file": "crabby-beach-v.097-code.md",
    "bytes": 181871,
    "mtime": "2026-09-10T14:33:28.048Z"
  },
  "codebase": {
    "version": "v.090",
...
export const APP_VERSION = "v.098";
