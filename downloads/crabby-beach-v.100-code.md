...
Green crab is the biggest cutest loadout.
```

## export-naming.md

```md
# export-naming.md — v.101

Current product version: **v.100** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.101**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.099",
    "file": "crabby-beach-v.099-code.md",
    "bytes": 181707,
    "mtime": "2026-09-10T14:53:18.988Z"
  },
  "codebase": {
    "version": "v.090",
