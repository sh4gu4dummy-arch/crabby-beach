...
Green holds a brush. Loadout art: view idle-0 vs original, then verify-crab-brush.py.
```

## export-naming.md

```md
# export-naming.md — v.105

Current product version: **v.104** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.105**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.103",
    "file": "crabby-beach-v.103-code.md",
    "bytes": 182502,
    "mtime": "2026-09-10T15:47:36.820Z"
  },
  "codebase": {
    "version": "v.090",
