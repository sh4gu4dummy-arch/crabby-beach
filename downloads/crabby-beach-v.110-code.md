...
Cartoon plan v.002 (ep 1.1). No clips shot yet.
```

## export-naming.md

```md
# export-naming.md — v.111

Current product version: **v.110** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.111**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.109",
    "file": "crabby-beach-v.109-code.md",
    "bytes": 183719,
    "mtime": "2026-09-10T17:15:03.820Z"
  },
  "codebase": {
    "version": "v.090",
...
export const APP_VERSION = "v.110";
