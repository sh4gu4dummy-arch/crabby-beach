...
Cartoon plan v.003. Ep 1.1 part 1 (beat A) in Cinema.
```

## export-naming.md

```md
# export-naming.md — v.112

Current product version: **v.111** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.112**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.110",
    "file": "crabby-beach-v.110-code.md",
    "bytes": 183727,
    "mtime": "2026-09-10T18:56:41.488Z"
  },
  "codebase": {
    "version": "v.090",
...
export const APP_VERSION = "v.111";
