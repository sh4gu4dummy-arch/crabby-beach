...
Ep 1.1 part 1 is a real Imagine cartoon, kid voice muxed.
```

## export-naming.md

```md
# export-naming.md — v.114

Current product version: **v.113** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.114**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.112",
    "file": "crabby-beach-v.112-code.md",
    "bytes": 186798,
    "mtime": "2026-09-10T19:16:46.692Z"
  },
  "codebase": {
    "version": "v.090",
...
export const APP_VERSION = "v.113";
