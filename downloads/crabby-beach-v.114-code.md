...
Ep 1.1 part 1: Imagine clip with talking mouth, kid voice lined up.
```

## export-naming.md

```md
# export-naming.md — v.115

Current product version: **v.114** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.115**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.113",
    "file": "crabby-beach-v.113-code.md",
    "bytes": 186816,
    "mtime": "2026-09-10T19:19:24.632Z"
  },
  "codebase": {
    "version": "v.090",
...
export const APP_VERSION = "v.114";
