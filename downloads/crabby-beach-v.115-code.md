...
Ep 1.1 is 12s: hi + let's paint a shell red.
```

## export-naming.md

```md
# export-naming.md — v.116

Current product version: **v.115** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.116**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.114",
    "file": "crabby-beach-v.114-code.md",
    "bytes": 186826,
    "mtime": "2026-09-11T03:44:41.551Z"
  },
  "codebase": {
    "version": "v.090",
...
export const APP_VERSION = "v.115";
