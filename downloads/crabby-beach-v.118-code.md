...
Ep 1.1 is one 10s I2V take. Imagine audio. No mux, no stitch.
```

## export-naming.md

```md
# export-naming.md — v.119

Current product version: **v.118** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.119**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.117",
    "file": "crabby-beach-v.117-code.md",
    "bytes": 186801,
    "mtime": "2026-09-11T04:10:15.695Z"
  },
  "codebase": {
    "version": "v.090",
...
export const APP_VERSION = "v.118";
...
export function GameCanvas() {
  ...
  return (
    <div className="flex h-full min-h-[100vh] w-full justify-center overflow-hidden bg-sand" style={inGame ? { background: hud.skyFill } : nightBg}>
      ...
      {showCartoon && (
        <CartoonOverlay
          src={assetUrl("game/cinema/s01e01.mp4?v=118")}
          muted={muted}
          onMute={toggleMute}
