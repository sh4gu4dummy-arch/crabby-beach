...
Ep 1.1 uses locked Crabby kid voice, not Imagine's British voice.
```

## export-naming.md

```md
# export-naming.md — v.120

Current product version: **v.119** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.120**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.118",
    "file": "crabby-beach-v.118-code.md",
    "bytes": 186809,
    "mtime": "2026-09-11T04:14:09.331Z"
  },
  "codebase": {
    "version": "v.090",
...
export const APP_VERSION = "v.119";
...
export function GameCanvas() {
  ...
  return (
    <div className="flex h-full min-h-[100vh] w-full justify-center overflow-hidden bg-sand" style={inGame ? { background: hud.skyFill } : nightBg}>
      ...
      {showCartoon && (
        <CartoonOverlay
          src={assetUrl("game/cinema/s01e01.mp4?v=119")}
          muted={muted}
          onMute={toggleMute}
...
function lookSrc(color: CrabColor, hat: CrabHat) {
  ...
  return assetUrl(`game/crabby/looks/${color}/${hat}/idle-0.png?v=109`);
}
