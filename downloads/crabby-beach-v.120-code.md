...
Ep 1.1 Imagine audio. Voice is in the prompt. Do NOT mux TTS.
```
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.119",
    "file": "crabby-beach-v.119-code.md",
    "bytes": 186813,
    "mtime": "2026-09-11T04:16:18.191Z"
  },
  "codebase": {
    "version": "v.090",
...
export function GameCanvas() {
  ...
  return (
    <div className="flex h-full min-h-[100vh] w-full justify-center overflow-hidden bg-sand" style={inGame ? { background: hud.skyFill } : nightBg}>
      ...
      {showCartoon && (
        <CartoonOverlay
          src={assetUrl("game/cinema/s01e01.mp4?v=120")}
          muted={muted}
          onMute={toggleMute}
