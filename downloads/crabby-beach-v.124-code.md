...
Ep 1.2 Red Crabby meets Green Crabby. Imagine audio. No mux.
```

## export-naming.md

```md
# export-naming.md — v.125

Current product version: **v.124** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.125**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.123",
    "file": "crabby-beach-v.123-code.md",
    "bytes": 186815,
    "mtime": "2026-09-11T05:01:58.747Z"
  },
  "codebase": {
    "version": "v.090",
