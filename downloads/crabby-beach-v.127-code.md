...
Loadout brushes: baked sprite per paint, same swap as red.
```

## export-naming.md

```md
# export-naming.md — v.128

Current product version: **v.127** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.128**.
...
export const APP_VERSION = "v.127";
