...
```md
# export-naming.md — v.083

Current product version: **v.082** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.083**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.081",
    "file": "crabby-beach-v.081-code.md",
    "bytes": 173202,
    "mtime": "2026-09-08T14:19:01.148Z"
  },
  "codebase": {
    "version": "v.080",
...
export const APP_VERSION = "v.082";
