...
```md
# export-naming.md — v.090

Current product version: **v.089** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.090**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.088",
    "file": "crabby-beach-v.088-code.md",
    "bytes": 177144,
    "mtime": "2026-09-10T07:20:08.436Z"
  },
  "codebase": {
    "version": "v.080",
...
export const APP_VERSION = "v.089";
