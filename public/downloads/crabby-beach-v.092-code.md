...
```md
# export-naming.md — v.093

Current product version: **v.092** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.093**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.091",
    "file": "crabby-beach-v.091-code.md",
    "bytes": 180890,
    "mtime": "2026-09-10T14:06:16.704Z"
  },
  "codebase": {
    "version": "v.090",
...
export const APP_VERSION = "v.092";
