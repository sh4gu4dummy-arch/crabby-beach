...
```md
# export-naming.md — v.095

Current product version: **v.094** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.095**.
...
export const APP_VERSION = "v.094";
