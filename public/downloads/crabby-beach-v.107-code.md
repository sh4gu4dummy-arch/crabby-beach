...
10pm–12am moonlight, less crush-dark.
```

## export-naming.md

```md
# export-naming.md — v.108

Current product version: **v.107** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.108**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.106",
    "file": "crabby-beach-v.106-code.md",
    "bytes": 182677,
    "mtime": "2026-09-10T16:29:40.768Z"
  },
  "codebase": {
    "version": "v.090",
