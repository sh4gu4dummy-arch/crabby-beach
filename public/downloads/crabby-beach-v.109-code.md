...
Green crab is the cute happy one with a brush, no pink outline.
```

## export-naming.md

```md
# export-naming.md — v.110

Current product version: **v.109** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.110**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.108",
    "file": "crabby-beach-v.108-code.md",
    "bytes": 183712,
    "mtime": "2026-09-10T16:56:12.340Z"
  },
  "codebase": {
    "version": "v.090",
...
export const APP_VERSION = "v.109";
