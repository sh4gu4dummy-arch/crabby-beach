...
Cinema cartoons autoplay on poster tap.
```

## export-naming.md

```md
# export-naming.md — v.113

Current product version: **v.112** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.113**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.111",
    "file": "crabby-beach-v.111-code.md",
    "bytes": 187217,
    "mtime": "2026-09-10T19:13:24.016Z"
  },
  "codebase": {
    "version": "v.090",
...
export const APP_VERSION = "v.112";
