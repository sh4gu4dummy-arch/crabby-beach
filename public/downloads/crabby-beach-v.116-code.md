...
Ep 1.1 continues from last frame (I2V), same crab paints red.
```

## export-naming.md

```md
# export-naming.md — v.117

Current product version: **v.116** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.117**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.115",
    "file": "crabby-beach-v.115-code.md",
    "bytes": 186792,
    "mtime": "2026-09-11T03:54:39.087Z"
  },
  "codebase": {
    "version": "v.090",
...
export const APP_VERSION = "v.116";
...
export function GameCanvas() {
  ...
  return (
    <div className="flex h-full min-h-[100vh] w-full justify-center overflow-hidden bg-sand" style={inGame ? { background: hud.skyFill } : nightBg}>
      ...
      {showCartoon && (
        <CartoonOverlay
          src={assetUrl("game/cinema/s01e01.mp4?v=116")}
          muted={muted}
          onMute={toggleMute}
