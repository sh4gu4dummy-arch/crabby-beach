...
Ep 1.1 I2V from last frame with image.url (real I2V).
```

## export-naming.md

```md
# export-naming.md — v.118

Current product version: **v.117** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.118**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.116",
    "file": "crabby-beach-v.116-code.md",
    "bytes": 186809,
    "mtime": "2026-09-11T03:59:58.187Z"
  },
  "codebase": {
    "version": "v.090",
...
export const APP_VERSION = "v.117";
...
export function GameCanvas() {
  ...
  return (
    <div className="flex h-full min-h-[100vh] w-full justify-center overflow-hidden bg-sand" style={inGame ? { background: hud.skyFill } : nightBg}>
      ...
      {showCartoon && (
        <CartoonOverlay
          src={assetUrl("game/cinema/s01e01.mp4?v=117")}
          muted={muted}
          onMute={toggleMute}
