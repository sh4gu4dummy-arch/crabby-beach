...
Green brush paints green. Do not treat bug reports as feature requests.
```
...
- This naming document started at `v.001` and is now **v.123**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.121",
    "file": "crabby-beach-v.121-code.md",
    "bytes": 186837,
    "mtime": "2026-09-11T04:25:41.675Z"
  },
  "codebase": {
    "version": "v.090",
...
export const APP_VERSION = "v.122";
