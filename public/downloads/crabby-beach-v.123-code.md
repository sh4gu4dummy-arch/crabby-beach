...
Green crab bucket hat sits on the shell, not floating, not chopped.
```

## export-naming.md

```md
# export-naming.md — v.124

Current product version: **v.123** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.124**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.122",
    "file": "crabby-beach-v.122-code.md",
    "bytes": 186819,
    "mtime": "2026-09-11T04:27:48.707Z"
  },
  "codebase": {
    "version": "v.090",
...
export const APP_VERSION = "v.123";
