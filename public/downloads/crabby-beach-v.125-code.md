...
Ep 1.3 Red meets Yellow. Ep 1.4 Red meets Blue.
```

## export-naming.md

```md
# export-naming.md — v.126

Current product version: **v.125** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.126**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.124",
    "file": "crabby-beach-v.124-code.md",
    "bytes": 187849,
    "mtime": "2026-09-11T05:09:45.587Z"
  },
  "codebase": {
    "version": "v.090",
