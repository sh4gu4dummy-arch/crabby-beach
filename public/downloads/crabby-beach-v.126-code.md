...
Loadout brushes follow the paint can, same as red Crabby.
```

## export-naming.md

```md
# export-naming.md — v.127

Current product version: **v.126** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.127**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.125",
    "file": "crabby-beach-v.125-code.md",
    "bytes": 189880,
    "mtime": "2026-09-11T05:52:46.273Z"
  },
  "codebase": {
    "version": "v.090",
...
export const APP_VERSION = "v.126";
