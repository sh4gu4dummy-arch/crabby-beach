...
Yellow hats sit on the shell in Loadout.
```

## export-naming.md

```md
# export-naming.md — v.130

Current product version: **v.129** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.130**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.128",
    "file": "crabby-beach-v.128-code.md",
    "bytes": 190579,
    "mtime": "2026-09-11T12:00:14.291Z"
  },
  "codebase": {
    "version": "v.090",
