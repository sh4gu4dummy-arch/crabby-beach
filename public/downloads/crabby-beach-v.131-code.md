...
Project agent: AGENTS.project.md. Handoff: GROK-BUILDER-NOTES.md.
```

## export-naming.md

```md
# export-naming.md — v.132

Current product version: **v.131** (Crabby Beach)
...
- This naming document started at `v.001` and is now **v.132**.
...
export const EXPORTS: Record<ExportKind, ExportFile | null> = {
  "codeOnly": {
    "version": "v.130",
    "file": "crabby-beach-v.130-code.md",
    "bytes": 193845,
    "mtime": "2026-09-17T02:06:59.354Z"
  },
  "codebase": {
    "version": "v.090",
...
export const APP_VERSION = "v.131";
