...
def write_android(www: Path) -> Path:
    ...
    (java / "MainActivity.java").write_text(
        ...
        "  }\n"
        "  private boolean jsTrue(String value) {\n"
        ...
        "      \"(function(){try{if(window.__crabbyBack){return !!window.__crabbyBack();}return false;}catch(e){return false;}})()\",\n"
        "      new ValueCallback<String>() {\n"
        "        @Override public void onReceiveValue(String value) {\n"
        "          if (jsTrue(value)) return;\n"
